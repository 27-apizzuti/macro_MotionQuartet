...
for su in SUBJ:
    ...
    PATH_GLM = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'GLM_model6', 'MultiRuns')
    PATH_VTC = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'VTC_MNI')
    PATH_SDM = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'GLM_model6', 'SDM')
    ...
    for task in TASKS:
        ...
        for itrun in RUNS:
            ...
            sdm = os.path.join(PATH_SDM, '{}_{}0{}_model6_MOCO.sdm'.format(su, task, itrun))
