...
for su in SUBJ:
    ...
    PATH_GLM = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'GLM_model7', 'MultiRuns')
    PATH_VTC = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'VTC_MNI')
    PATH_SDM = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'GLM_model7', 'SDM')
    ...
    for task in TASKS:
        ...
        for itrun in RUNS:
            ...
            sdm = os.path.join(PATH_SDM, '{}_{}0{}_model7_MOCO.sdm'.format(su, task, itrun))
