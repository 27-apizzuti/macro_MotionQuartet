...
TASKS = ['phy', 'amb']
PATH_GLM = os.path.join(STUDY_PATH, 'GLM_model5')
...
for task in TASKS:
    ...
    for su in SUBJ:
        ...
        PATH_SDM = os.path.join(STUDY_PATH, su, 'func', 'GLM_model5', 'SDM')
        ...
        for itrun in RUNS:
            ...
            sdm = os.path.join(PATH_SDM, '{}_{}0{}_model5_MOCO.sdm'.format(su, task, itrun))
    ...
    doc.save_multistudy_glm_definition_file(os.path.join(PATH_GLM, 'AllSbj_{}_model5_MOCO_PSC_SEPSTUDYPREDS_N-{}_RFX.mdm'.format(task, len(SUBJ))))
