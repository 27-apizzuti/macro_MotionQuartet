...
for su in SUBJ:
    ...
    PATH_GLM = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'GLM_model5')
    ...
    for ru in RUNS:
        ...
        if task == 'phy':
            PATH_PROTOCOL = os.path.join(STUDY_PATH, 'Protocols', su, 'Exp1_Phys_MotQuart', 'Protocols', 'Protocol_{}_Exp2_unamb_MotQuart_Run{}_model5.prt'.format(su, runID))
        else:
            PATH_PROTOCOL = os.path.join(STUDY_PATH, 'Protocols', su, 'Exp1_Amb_MotQuart', 'Protocols', 'Protocol_{}_Protocols_sess-03_Run{}_model5.prt'.format(su, runID))
        ...
        docVMR.add_predictor("Block")
        docVMR.set_predictor_values_from_condition("Block", "Block", 1)
        docVMR.apply_hrf_to_predictor("Block")
        ...
        outname = os.path.join(PATH_OUT, '{}_{}_model5.sdm'.format(su, ru))
        ...
        outname = os.path.join(PATH_OUT, '{}_{}_model5_MOCO.sdm'.format(su, ru))
