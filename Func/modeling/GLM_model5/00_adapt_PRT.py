...
for su in SUBJ:
    ...
    for ru in RUNS:
        ...
        if task == 'phy':
            ...
            # print(switch)
            print('Create block predictor')

            sust = copy(data[2])
            sust['NameOfCondition'] = 'Block'
            sust['Time start'] = data[3]['Time start'] - 80
            sust['Time stop'] = data[3]['Time start'] - 1
            ...
            outname = "{}_model5.prt".format(basename)
            ...
            sust = copy(data[3])
            sust['NameOfCondition'] = 'Block'
            sust['Time start'] = flick['Time start'] - 80000
            sust['Time stop'] = flick['Time start']
            sust['NrOfOccurances'] = len(sust['Time start'])
            print(sust)
