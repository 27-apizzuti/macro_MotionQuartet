...
load(['E:\WB-MotionQuartet\derivatives\res_tc\BV_visuals\AllSubj_runs_demeanDetr_filt_1_' TASK 'NonRever_wholebrain_DRIVING_SCORE.mat'])
%% 
smp = xff(SMP_NAME);
poi = xff(POI_NAME);
...
smp.SaveAs(['E:\WB-MotionQuartet\derivatives\res_tc\BV_visuals\' TASK, 'WHOLEBRAIN_DRIVING_SCORE_' HEMI '.smp']);
disp('Done.')
