...
SUB = ['sub-03', 'sub-04', 'sub-05', 'sub-06', 'sub-07', 'sub-08', 'sub-09', 'sub-10']
TASK = ['amb', 'phy']
...
for su in SUB:
    ...
    for ta in TASK:
        ...
        VTC_list = glob(os.path.join(STUDY_PATH, su, 'func', 'VTC_MNI', '{}_task-{}_run-0*_acq-2depimb4_SCSTBL_3DMCTS_bvbabel_undist_fix_THPGLMF3c_BBR_native_bvbabel_resx1_float32_bvbabel_resx1_float32_MNI.vtc'.format(su, ta)))
