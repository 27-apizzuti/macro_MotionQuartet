...
MAIN_PATH = '/mnt/e/WB-MotionQuartet'
TR_in_ms = 1000
TASK = 'phy'
...
for su in SUBJ:
	...
	if TASK == 'amb':
		PRTS_FILES = [glob("/mnt/e/WB-MotionQuartet/Protocols/{}/Exp1_Amb_MotQuart/Protocols/orig/Protocol_{}_Protocols_sess-03_Run0*.prt".format(su, su))]
	else:
		PRTS_FILES = [glob("/mnt/e/WB-MotionQuartet/Protocols/{}/Exp1_Phys_MotQuart/Protocols/orig/Protocol_{}_Exp2_unamb_MotQuart_Run*.prt".format(su, su))]
	...
	NII_TC = os.path.join(MAIN_PATH, 'derivatives', su, 'func',  'GEC', '{}_{}_VOICarpet.nii.gz'.format(su, TASK))
	PATH_IN = os.path.join(MAIN_PATH, 'derivatives', su, 'func',  'GEC')
