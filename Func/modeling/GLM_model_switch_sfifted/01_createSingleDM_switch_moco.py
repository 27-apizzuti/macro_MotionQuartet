...
RUNS = ["amb01", "amb02", "amb03", "amb04"]

for su in SUBJ:

    PATH_VTC = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'VTC_MNI')
    PATH_GLM = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'GLM_model2')
    ...
    for ru in RUNS:
        ...
        if task == 'phy':
            ...
            PATH_PROTOCOL = os.path.join(STUDY_PATH, 'Protocols', su, 'Exp1_Amb_MotQuart', 'Protocols', 'Protocol_{}_Protocols_sess-03_Run{}_model2_shifted.prt'.format(su, runID))
        ...
        outname = os.path.join(PATH_OUT, '{}_{}_model2.sdm'.format(su, ru))
        ...
        outname = os.path.join(PATH_OUT, '{}_{}_model2_shifted_MOCO.sdm'.format(su, ru))
