...
for ta in TASK:
	for su in SUBJ:
		...
		# Timecourses
		NII_TC = sorted(glob(os.path.join(PATH_IN, "{}_task-{}*bvbabel.nii.gz".format(su, ta))))

		# Voxels of interest / regions of interest
		NII_VOI = os.path.join(PATH_IN, "Glasser_MNI_bilateral_NATIVE_VOIinVTCspace.nii.gz")
