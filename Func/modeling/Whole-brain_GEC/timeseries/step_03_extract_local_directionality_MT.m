...
task = 'phy';
res_amb = load(['E:\Arrow_of_time\data\res_tc\AllSubj_runs_demeanDetr_filt_1_', task, 'NonRever.mat']);
...
for sub=1:N_SUB
    ...
    seed_driving_mean = nanmean(seed_driving, 1);
    seed_following_mean = nanmean(seed_following, 2);
...
save(['E:\Arrow_of_time\data\res_tc\AllSubj_runs_demeanDetr_filt_1_' task 'NonRever_MT_DRIVING_SCORE.mat'], 'avg', 'p_drive', 'p_follow');
