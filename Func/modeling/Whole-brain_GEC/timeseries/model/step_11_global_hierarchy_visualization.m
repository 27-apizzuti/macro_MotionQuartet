...
load(['E:\Arrow_of_time\data\res_model_tc\Allsbj_avg_GEC_model_tc_', TASK, '_wholebrain_HIERARCHY.mat'])
%% 
smp = xff(SMP_NAME);
poi = xff(POI_NAME);
...
smp.SaveAs(['E:\Arrow_of_time\data\res_model_tc\' TASK, 'WHOLEBRAIN_HIERARCHY_' HEMI '.smp']);
disp('Done.')
...
load(['E:\Arrow_of_time\data\res_model_tc\Allsbj_avg_GEC_model_tc_AllTask_wholebrain_HIERARCHY.mat'])
...
smp.SaveAs(['E:\Arrow_of_time\data\res_model_tc\WHOLEBRAIN_HIERARCHY_changes_' HEMI '.smp']);
disp('Done.')