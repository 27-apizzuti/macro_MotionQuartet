...
res_phy = load("E:\Arrow_of_time\data\res_tc\AllSubj_runs_demeanDetr_filt_1_phyNonRever.mat");

res_amb = load("E:\Arrow_of_time\data\res_tc\AllSubj_runs_demeanDetr_filt_1_ambNonRever.mat");

res_rest = load("E:\Arrow_of_time\data\res_tc\AllSubj_runs_demeanDetr_filt_1_restNonRever.mat");

resultspath = "E:\Arrow_of_time\data\res_tc";
...
categ = cat(1, repmat("PHY", 9, 1), repmat("AMB", 9, 1), repmat("REST", 89, 1));
figure
