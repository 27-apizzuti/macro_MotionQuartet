...
for su in SUBJ:
    ...
    PATH_GLM = os.path.join(STUDY_PATH, 'derivatives', su, 'func', 'GLM_model3')
    ...
    for ru in RUNS:
        ...
        outname = os.path.join(PATH_OUT, '{}_{}_model3.sdm'.format(su, ru))
        ...
        outname = os.path.join(PATH_OUT, '{}_{}_model3_MOCO.sdm'.format(su, ru))
