...
STUDY_PATH = '/mnt/e/WB-MotionQuartet'
...
for su in SUBJ:
    ...
    for ru in RUNS:
        ...
        switch['Time start'] = (np.sort(np.concatenate((hor['Time start'], ver['Time start']), axis=0)).astype(int)) - int(1000)
        ...
        outname = "{}_model2_shifted.prt".format(basename)
