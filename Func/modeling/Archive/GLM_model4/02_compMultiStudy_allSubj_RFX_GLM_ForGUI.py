...
TASKS = ['phy', 'amb']
PATH_GLM = os.path.join(STUDY_PATH, 'GLM_model4')
...
for task in TASKS:
    ...
    for su in SUBJ:
        ...
        PATH_SDM = os.path.join(STUDY_PATH, su, 'func', 'GLM_model4', 'SDM')
    ...
    doc.save_multistudy_glm_definition_file(os.path.join(PATH_GLM, 'AllSbj_{}_model4_MOCO_PSC_SEPSTUDYPREDS_N-{}_RFX.mdm'.format(task, len(SUBJ))))
